function  [lambda,efficiency,ecc,radius,diameter] = charpath(connMatrixTH)
...
% last updated: 22/02/2014 - Daniele Poli
...
Parameters_path = zeros(1,5);
Parameters_path(1,1) = lambda;
%Parameters_path(1,2) = ecc;
Parameters_path(1,2) = radius;
Parameters_path(1,3) = diameter;
Parameters_path(1,4) = efficiency;

save Parameters_path;
